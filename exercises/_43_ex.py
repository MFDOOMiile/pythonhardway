###~~~Basic Object-Oriented Analysis & Design~~~###
###~~~GOTHONS FROM PLANET PERCAL #25 (Game)~~~###
...
class Death(Scene):
    ...
    quips = [
        "You died! You kinda suck at this... Sucks to suck.",
...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        print(dedent("""
              You do a dive roll into the Weapon Armory, crouch and scan the room for more Gothons that might be hiding. It's dead quiet, too quiet. You stand up and run to the far side of the room and find the neutron bomb inits container. There's a keypad lock on the box and you need the code to get the bomb out. If you get the code wrong 10 times then the lock closes forever and you cnt' get the bomb. The code is 3 digits.
              """))
